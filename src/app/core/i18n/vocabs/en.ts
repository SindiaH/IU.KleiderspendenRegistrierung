...
export const locale: LanguageInfo = {
  ...
  data: {
    ...
    "IMPRESSUM_TEXT": {
      "TITLE": "Impressum",
      "LAW": "Imprint according to §24(3) Media Law",
    ...
    "HOME_TEXT": {
      ...
      "TITLE": "Helping Hand",
      "WELCOME": "Welcome to the Fair Aid Association – where your generosity counts and you decide where it's needed.",
      ...
      "LEFT_1": "The world is full of challenges, and there are many people in desperate need of help. From the conflict regions in the Middle East to the poverty-stricken regions in Africa – the need knows no bounds.",
      ...
      "LEFT_4": "Welcome to the Fair Aid Association – where your help is well placed and will definitely reach the people who desperately need it.",
